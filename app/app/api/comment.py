...
def read_comments_id_character(character_id:int):
    return comment_manager.get_by_id_character(character_id), 200


@router.get("/comments/episodes/{episode_id}")
def read_comments_id_episode(episode_id:int):
    return comment_manager.get_by_id_episode(episode_id), 200


@router.get("/comments/characters/{character_id}/episodes/{episode_id}")
def read_comments_id_character_and_episode(character_id:int, episode_id:int):
    return comment_manager.get_by_id_character_and_episode(character_id,episode_id), 200
